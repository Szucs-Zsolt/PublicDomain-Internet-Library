...
namespace PublicDomainInternetLibrary.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Eredeti jelszó")]
            public string OldPassword { get; set; }

            [Required(ErrorMessage = "{0} megadása szükséges")]
            [StringLength(100,
             ErrorMessage = "{0} hossza {2} - {1} karakter között legyen.", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Nem sikerült megváltoztatni a jelszót.";
